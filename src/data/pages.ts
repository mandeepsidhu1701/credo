export const pages = {
  home: {
    title: "Credo Migration Services — NZ Licensed Immigration Advisers",
    description:
      "Licensed New Zealand immigration adviser (IAA #201300026). Expert visa and residence services: skilled migrant, work, student, family and investor visas.",
    hero: {
      eyebrow: "Licensed Immigration Adviser #201300026",
      titleLead: "Your Journey to",
      titleHighlight: "New Zealand",
      titleTrail: "Starts Here",
      description:
        "Expert immigration advice and visa services. We guide you through every step of your migration journey with care and professionalism.",
    },
  },
  about: {
  ...
  services: {
    title: "Immigration & Visa Services | Credo Migration NZ",
    description:
      "Skilled migrant, work, student, family, investor and visitor visa services in New Zealand from a licensed immigration adviser.",
  },
  testimonials: {
  ...
  posts: {
    ...
    description:
      "Latest New Zealand immigration news, policy updates, and visa application guides from licensed immigration advisers.",
  },
  contact: {
